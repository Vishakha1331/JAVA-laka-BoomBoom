...
private String memberlists =new String();
private DownloadSong downloadSongnamee;    
public mp3playeroffline mpp;
/**
    ...
    private void initComponents() {
        ...
        backalter = new javax.swing.JButton();
        ...
        homecardLayout.setVerticalGroup(
            ...
            .addGroup(homecardLayout.createSequentialGroup()
                ...
                .addGroup(homecardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(homecardLayout.createSequentialGroup()
                        .addComponent(newsongbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(36, 36, 36)
                        .addComponent(trendingbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(57, 57, 57)
                        .addComponent(recommendedbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        filtergenre.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--SELECT--", "POP", "ROCK", "RAP", "INDIE", "DANCE", "ELECTRONIC", "HIPHOP", " ", " " }));

        filterartist.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--SELECT--", "ED SHEERAN", "EMINEM", "BILLIE ELISH", "THE CHAINSMOKERS", "POST MELON", "MARSHMELLO", "JUSTIN BIEBER", " ", " ", " ", " ", " " }));
        ...
        searchcardLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, searchcardLayout.createSequentialGroup()
                .addGap(109, 109, 109)
                .addComponent(filterbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        nowcardLayout.setHorizontalGroup(
            ...
            .addGroup(nowcardLayout.createSequentialGroup()
                ...
                .addGroup(nowcardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(displayupdated, javax.swing.GroupLayout.PREFERRED_SIZE, 376, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(nowcardLayout.createSequentialGroup()
                ...
                .addGroup(groupscardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(groupscardLayout.createSequentialGroup()
                        ...
                        .addGroup(groupscardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(okcreatebutton, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(49, 49, 49)
                        .addComponent(jLabel22)
                        .addGap(18, 18, 18)
                    ...
                    .addGroup(groupscardLayout.createSequentialGroup()
                        ...
                        .addGroup(groupscardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(groupscardLayout.createSequentialGroup()
                                .addComponent(memberofgroupbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(groupplaylistbutton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jLabel44.setText("SONGS:");

        jLabel45.setText("SEARCH RESULTS:");

        backalter.setText("BACK");
        backalter.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                backalterMouseClicked(evt);
            }
        });
            ...
            .addGroup(historycardLayout.createSequentialGroup()
                ...
                .addGroup(historycardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(historycardLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(recentbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(mostplayedbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(27, 27, 27)
            ...
            .addGroup(profilecardLayout.createSequentialGroup()
                ...
                .addGroup(profilecardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, profilecardLayout.createSequentialGroup()
                        .addGap(58, 58, 58)
                        .addComponent(logoutb, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(40, 40, 40)
                ...
                .addGap(18, 18, 18)
                .addGroup(profilecardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(namechangerfield, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(profilecardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(profilecardLayout.createSequentialGroup()
                        ...
                        .addGroup(profilecardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel31)
                            .addComponent(emailchangerfield, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(profilecardLayout.createSequentialGroup()
                        .addGap(4, 4, 4)
...
//button to see new added sogs in server(.basic-9)
    ...
    private void newsongbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newsongbuttonActionPerformed
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                //creating request to ask for new songs
                ...
                try {
                    ...
                    if(response.getResponseCode().equals(ResponseCode.SUCCESSFUL)){
                        ...
                        //creating model to apply on jlist
                        DefaultListModel model=new DefaultListModel();
                        model.removeAllElements();
                        songlistmenu.setModel(model);
                        for (int i=0;i<len;i++){
                            //adding elements in to model
                            model.add(i,songArray.get(i));
                        }
                        //applying model in jlist
        ...
        }).start();//starting the thread initiated(anonymous class)
    }//GEN-LAST:event_newsongbuttonActionPerformed

// button to add any song searched from homepage to queue
...
//button to get the home card(homepage tab)
...
//button to get the search card(search tab)
...
//button to get the queue card(queue tab)
    ...
    //button to get the playlist card(playlist tab)
    private void playlistbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_playlistbMouseClicked
        ...
        historycard.setVisible(false);
        profilecard.setVisible(false);
        //to get the playlist of a particular user automatically update on going to playlist card
    ...
    //button to get the group card(group tab)
    ...
    private void groupsbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_groupsbMouseClicked
        ...
        //thread to get the all groups of a user on pressing the group tab button
        new Thread(new Runnable() {
    ...
    //button to get history card(history tab)
...
//button to get profile card (profile tab)
    private void profilebMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_profilebMouseClicked
        ...
        //updating the unedittable text field
...
//adding song to group playllist,already created (basic-14)
...
// to get the trenidng song, on basis of their playcounts(advanced-7)
    ...
    //getting recomended sog for a particular user on basis of various factors like,the time of day,genre prefered,and past hhistory (advanced-5)(advanced-6)
...
// filtering songs on basis of artist, language,genre or name (multi level filters) (basic-11)
...
//to get the history of songs played by a particular user (basic-6)
...
//to get the recent songs played by a user (basic-4)
...
// to see the mopst played songs oa a particular user (basic-4)
...
// to allow user to updtae their name or email in profile card(extra functionality)
...
// to allow user toi delete some song from now playing editable queue(basic-7)
...
//to allow user to add whole playlist or group of songs in to queue (basic-7)
...
// add a particular selected song in to the queue 
...
//add whole playlist to queue(baic-7)
...
// to create a personal playlist for a user(basic-5)
...
// to add song to a playlist (basic-5)
...
//to view songs of a playlist (basic-5)
...
// to update queue, on rearranging the order of songs(basic-7)
...
//to share a playlist with some other user (advanced-8)
...
// to add some member to a group(basic-13)
...
// to get the playlist of a particular group for a user (basic-14)
...
// create a new group playlist ,where each member has equal rights(basic-14)
...
//to refresh the playlist menu of a group
...
// to add song into a group laylist(basic-14)
...
// to download a song for playing offline(basic-10)
    ...
    private void downlaodsongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_downlaodsongActionPerformed
        ...
        try {
            downloadSongnamee =new DownloadSong(downloadsongname,false);
        } catch (IOException ex) {
            Logger.getLogger(mainpage.class.getName()).log(Level.SEVERE, null, ex);
        }
...
// to play downloaded songs(basic-10)
    private void playdownlaodsbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_playdownlaodsbMouseClicked
        // TODO add your handling code here:
        mpp =new mp3playeroffline(this.queueEditor);
                
        mpp.setVisible(true);
        //mpp.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
...
//search a song to play or download....or add to playlist(basic-14)(baic-11)
...
// to create a new group(basic-13)
...
// to get the list of members of any particular group(basic-13)
...
// search song to add to grroup playlist(basic-14)
...
//back button functionality located on alter card
...
//back button functionality located on alter card
    private void backalterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backalterMouseClicked
        // TODO add your handling code here:
        altercard.setVisible(false);
        groupscard.setVisible(true);
        
        
    }//GEN-LAST:event_backalterMouseClicked
// logoput button functionality(basic-1)
    
    private void logouthojaega(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_logouthojaega
        // TODO add your handling code here:
        logout lg=new logout(MainClass.user.getUserName());
        mpp.close();
        mpp.dispose();
...
public JList getQueueDown(){
    ...
    private javax.swing.JButton backalter;
